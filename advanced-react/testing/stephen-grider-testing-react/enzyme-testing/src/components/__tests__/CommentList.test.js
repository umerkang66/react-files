...
beforeEach(() => {
  ...
  // We have to provide with initial state so that we can test with it, so as initial state we are passing 2 comments
  wrapped = mount(
...
it('shows the text for each comment', () => {
  ...
  // wrapped will render both "Comment 1" and "Comment 2", we can also check in the same line
